...
"pt": {
  ...
  "h1": "Apoie o projeto",
  "lead": "O RudiMaster é grátis e vai continuar assim. Se ele faz parte do seu treino, escolha abaixo como contribuir. Você define o valor.",
  "whatTitle": "Por que apoiar e para onde vai o dinheiro",
  "what": ["Sem anúncio, sem cadastro e sem versão paga escondida atrás de um paywall. O apoio é o que sustenta essa escolha.",
           "Domínio e hospedagem, que são os custos fixos do site.",
...
"en": {
  ...
  "lead": "RudiMaster is free and will stay that way. If it is part of your practice routine, pick how to contribute below. You choose the amount.",
  "whatTitle": "Why support it and where the money goes",
  "what": ["No ads, no sign-up and no paid tier hidden behind a paywall. Support is what sustains that choice.",
           "Domain and hosting, the fixed costs of running the site.",
...
"es": {
  ...
  "lead": "RudiMaster es gratis y seguirá siéndolo. Si forma parte de tu rutina, elige abajo cómo contribuir. Tú decides la cantidad.",
  "whatTitle": "Por qué apoyar y a dónde va el dinero",
  "what": ["Sin anuncios, sin registro y sin versión de pago escondida tras un muro. El apoyo es lo que sostiene esa decisión.",
           "Dominio y alojamiento, los costes fijos del sitio.",
