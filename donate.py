...
COPY = {
"pt": {
  "title": "Apoie o RudiMaster — ajude a comprar uma bateria eletrônica e manter a ferramenta gratuita",
  "desc": "O RudiMaster é gratuito e sem cadastro. As doações agora têm um destino concreto: uma bateria eletrônica para continuar os estudos que deram origem ao projeto. Pix ou cartão, com o valor que você escolher.",
  "h1": "Apoie o projeto",
  "lead": "As doações têm um destino concreto: comprar uma bateria eletrônica para continuar os estudos que deram origem ao RudiMaster, e manter a ferramenta no ar e gratuita. Escolha abaixo como contribuir. Você define o valor.",
  "whatTitle": "Para onde vai o dinheiro",
  "what": ["Primeiro objetivo: uma bateria eletrônica. O RudiMaster nasceu do meu estudo no pad, e o próximo passo é levar isso para o kit completo, melhorando a ferramenta com o que eu aprender no caminho.",
           "Manter a ferramenta aberta e gratuita para quem estuda, sem exigir cadastro nem pagamento.",
           "Domínio e hospedagem, que são os custos fixos de deixar o site no ar.",
           "Tempo de desenvolvimento: rudimentos novos, rotinas de treino salvas e histórico de andamento.",
           "Cada contribuição estica o tempo que o projeto consegue seguir sem depender de outra fonte de receita."],
...
"en": {
  "title": "Support RudiMaster — help fund an electronic drum kit and keep the tool free",
  "desc": "RudiMaster is free and needs no account. Donations now have a concrete goal: an electronic drum kit to continue the studies that started the project. Pix or card, any amount you choose.",
  "h1": "Support the project",
  "lead": "Donations have a concrete goal: buying an electronic drum kit to continue the studies that started RudiMaster, and keeping the tool online and free. Pick how to contribute below. You choose the amount.",
  "whatTitle": "Where the money goes",
  "what": ["First goal: an electronic drum kit. RudiMaster grew out of my practice on a pad, and the next step is taking that to a full kit, improving the tool with whatever I learn along the way.",
           "Keeping the tool open and free for anyone practising, with no sign-up and no payment required.",
           "Domain and hosting, the fixed costs of keeping the site online.",
           "Development time: more rudiments, saved practice routines and tempo history.",
           "Every contribution extends how long the project can run without leaning on another source of revenue."],
...
"es": {
  "title": "Apoya RudiMaster — ayuda a comprar una batería electrónica y mantener la herramienta gratuita",
  "desc": "RudiMaster es gratis y sin registro. Las donaciones ahora tienen un destino concreto: una batería electrónica para continuar los estudios que dieron origen al proyecto. Pix o tarjeta, con la cantidad que elijas.",
  "h1": "Apoya el proyecto",
  "lead": "Las donaciones tienen un destino concreto: comprar una batería electrónica para continuar los estudios que dieron origen a RudiMaster, y mantener la herramienta en línea y gratuita. Elige abajo cómo contribuir. Tú decides la cantidad.",
  "whatTitle": "A dónde va el dinero",
  "what": ["Primer objetivo: una batería electrónica. RudiMaster nació de mi estudio en el pad, y el siguiente paso es llevarlo al kit completo, mejorando la herramienta con lo que aprenda en el camino.",
           "Mantener la herramienta abierta y gratuita para quien practica, sin registro ni pago.",
           "Dominio y alojamiento, los costes fijos de tener el sitio en línea.",
           "Tiempo de desarrollo: más rudimentos, rutinas de práctica guardadas e historial de tempo.",
           "Cada contribución alarga el tiempo que el proyecto puede seguir sin depender de otra fuente de ingresos."],
