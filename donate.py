...
COPY = {
"pt": {
  "title": "Apoie o RudiMaster — ajude a manter a ferramenta no ar e gratuita",
  "desc": "O RudiMaster é gratuito e sem cadastro. Se ele te ajuda a treinar, sua contribuição ajuda a manter o projeto rodando. Pix ou cartão, com o valor que você escolher.",
  "h1": "Apoie o projeto",
  "lead": "Manter o RudiMaster no ar e gratuito depende de quem usa. Se ele faz parte do seu treino, escolha abaixo como contribuir. Você define o valor.",
  "whatTitle": "Por que apoiar e para onde vai o dinheiro",
  "what": ["Manter a ferramenta aberta e gratuita para quem estuda, sem exigir cadastro nem pagamento.",
...
"en": {
  "title": "Support RudiMaster — help keep the tool running and free",
  "desc": "RudiMaster is free and needs no account. If it helps your practice, your contribution helps keep the project running. Pix or card, any amount you choose.",
  "h1": "Support the project",
  "lead": "Keeping RudiMaster running and free depends on the people who use it. If it is part of your practice routine, pick how to contribute below. You choose the amount.",
  "whatTitle": "Why support it and where the money goes",
  "what": ["Keeping the tool open and free for anyone practising, with no sign-up and no payment required.",
...
"es": {
  "title": "Apoya RudiMaster — ayuda a mantener la herramienta en marcha y gratuita",
  "desc": "RudiMaster es gratis y sin registro. Si te ayuda a practicar, tu contribución ayuda a mantener el proyecto en marcha. Pix o tarjeta, con la cantidad que elijas.",
  "h1": "Apoya el proyecto",
  "lead": "Mantener RudiMaster en marcha y gratuito depende de quien lo usa. Si forma parte de tu rutina, elige abajo cómo contribuir. Tú decides la cantidad.",
  "whatTitle": "Por qué apoyar y a dónde va el dinero",
  "what": ["Mantener la herramienta abierta y gratuita para quien practica, sin registro ni pago.",
